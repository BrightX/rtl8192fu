...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(2, 6, 37)) && (LINUX_VERSION_CODE < KERNEL_VERSION(3, 10, 0))
...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(3, 10, 0)) || defined(RTW_VENDOR_EXT_SUPPORT)
