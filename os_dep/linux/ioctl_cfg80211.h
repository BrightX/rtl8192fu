...
#elif (LINUX_VERSION_CODE < KERNEL_VERSION(3, 12, 0) && RHEL_RELEASE_CODE != RHEL_RELEASE_VERSION(7, 1))
...
#if (LINUX_VERSION_CODE < KERNEL_VERSION(4, 2, 0) && RHEL_RELEASE_CODE < RHEL_RELEASE_VERSION(7, 3))
...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(2, 6, 26)) && (LINUX_VERSION_CODE < KERNEL_VERSION(4, 7, 0) && RHEL_RELEASE_CODE < RHEL_RELEASE_VERSION(7, 3))
